...
## Tiempo real (Laravel Reverb y notificaciones)

- **Infraestructura Reverb:** [REVERB.md](./REVERB.md)
- **Guía paso a paso (eventos, toasts, `currentPaths`, perfil):** [NOTIFICACIONES-Y-BROADCASTING.md](./NOTIFICACIONES-Y-BROADCASTING.md)
